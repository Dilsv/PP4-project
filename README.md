...
This website is a business that offers make up services, where users can create an account, book a table, read a blog and view the services on the bookings menu.
<hr>
...
1. As a Site user I can navigate across the site so that I can move around each of the features easily. [Must Have]
2. As a Site user I can use navbar and footer for social links across the site so that I can navigate the site, access services and view social links. [Must Have]
3. As a Site owner I can create a contact us page across the site so that I can see users who would like to be contacted. [Should Have]
...
7. As a Site user I can go to My Bookings on the navbar so that I can delete any booking. [Must Have]
8. As a Site user I can view the details of my booking so that I can be sure of the date and time. [Must Have]
9. As a Site user I am notified so that I get confirmation that I have added, deleted, edited or viewed successfully. [Should Have]
10. As a Site user I can sign up or register so that I can make a booking if I wish to. [Must Have]
11. As a Site user I can register to sign up to an account so that so my details preinstall when booking a service. [Must Have]
12. As a Site user I can login so that I can book a service. [Must Have]
13. As a Site user I can see my login status so that I can know when I am logged in and logged off. [Must Have]
14. As a Site user I can visit the site's blog to find out more information about the site so that I can read/get more information. [Must Have]
15. As a Site user I can use the about page so that I can get more information on the business. [Must Have]
16. As a Site user I can not book a past date so that I can make a valid booking. [Must Have]
17. As a Site user I can view blog posts individually so that I can avoid overcrowding. [Should Have]
...
#DILS#
As a Admin/Authorised user I can log in the site so that I can access the backend of the site. [Must Have]
As a Authorised User/Admin I can add bookings manually so that I can enter bookings made via phone or email. [Should Have]
As a Authorised User/Admin I can see the bookings made on the admin site so that I can accept or reject bookings to avoid overlap of bookings or long hours being booked. [Could Have]
As an 'Admin user I can add or remove services by logging into the site so that I can add more services or remove them. [Should Have]
As an Admin I can create, read, update and delete services from the directory so that I can change the services by adding, removing, viewing or editing them. [Should Have]
As an Admin/registered user I can search though services and bookings so that I can locate the information I am looking for. [Should Have]
As an Admin/registered user I can filter through bookings and services so that I can see what bookings I have made on specific dates. [Should Have]
...
#DILS#
As a Site owner I can give users a fully responsive site so that Users/potential are provided with good user experience. [Must Have]
As a Site user I can view the options of services so that I can choose which I would like to book for. [Must Have]
